...
export const COMMANDS = {
  ...
  CLEAR_ALL_DIRECTORY_MARKS_IN_PROJECT:
    "codefident.clearAllDirectoryMarksInProject",
...
export const MESSAGES = {
  ...
  ALL_LINE_MARKS_RESET:
    "Reset all line marks in the project ({count} files affected)",
  ALL_FILE_MARKS_RESET:
    "Reset all file marks in the project ({count} files affected)",
  ALL_DIRECTORY_MARKS_RESET:
    "Reset all directory marks in the project ({count} directories affected)",
};
